...
epigenetic_features <- function() {
    ...
    tf.sets <- c("Brd2_promoters", "Brd3_promoters", "Brd4_promoters", "HP1a_promoters", "HP1b_promoters", 'NRSF','STAT1-HeLaS3_Untr','STAT1-HeLaS3_INFS','STAT1-HeLaS3_INFS-2','ActivatedNucleosomes','RestingNucleosomes','Rest-CD4-HDAC1','Rest-CD4-HDAC2','Rest-CD4-HDAC3','Rest-CD4-HDAC6','Act-CD4-HDAC6','Rest-CD4-CBP','Rest-CD4-PCAF','Rest-CD4-p300','Rest-CD4-MOF','Rest-CD4-Tip60','Act-CD4-Tip60','H3_3-HeLa','p300-HeLa')
    ...
    display.order <- c("Brd2_promoters", "Brd3_promoters", "Brd4_promoters", "HP1a_promoters", "HP1b_promoters",
                       "H3K9me2", "H3K9me2-HeLa", "H3K9me3", "H3K9me3-MEF", 
